...
export const testimonials5 = [
  {
    text: "The Toronto Heat Pump Rebate made the switch to a heat pump a breeze. I saved $7,500 and now my home is comfortable all year round. Highly recommended!",
    author: "Thomas Johnson",
    location: "Markham, ON",
  ...
  {
    text: "The Toronto Heat Pump Rebate made it easy to navigate the rebate program and maximize my savings. My energy bills have been greatly reduced!",
    author: "Peter Rebel",
  ...
  {
    text: "I was very pleased with the simple help from the Toronto Heat Pump Rebate and was able to receive a $7,500 rebate. The comfort of my home is now unmatched!",
    author: "Alice Watson",
    location: "Toronto, ON",
